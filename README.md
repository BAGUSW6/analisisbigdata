...
Dataset "Hotel Bookings" yang digunakan dalam proyek TidyTuesday pada 11 Februari 2020 berasal dari penelitian Antonio, Almeida, dan Nunes (2019). Data yang dikumpulkan antara 2015 hingga 2017 ini memiliki 32 variabel dan bertujuan untuk menganalisis faktor-faktor yang memengaruhi pembatalan pemesanan hotel.

Data diimpor melalui tautan unduhan yang diekstrak dari URL Dropbox. Terdapat nilai NULL pada variabel company sebanyak 112.593 dan agent sebanyak 16.340. Nilai NULL ini tidak berarti benar-benar kosong, melainkan dapat diasumsikan sebagai individu atau personal yang datang tanpa melibatkan perusahaan atau agen luar. Pembersihan data dilakukan dengan menghapus kolom country yang memiliki 488 nilai NULL dan kolom children yang memiliki 4 nilai NULL, karena kolom-kolom tersebut tidak dapat dianalisis lebih lanjut.

| Variabel               | Nilai Null(Before)                                   |Nilai Null(After) |
|------------------------|------------------------------------------------------|------------------|
| `children`             | 4                                                    | 0                |
| `country`              | 488                                                  | 0                |
| Total Keseluruhan Data | 119.390                                              |118.898           |

3.4 Total data sebelum dilakukan pembersihan berjumlah 119.390 dan setelah dilakukan pembersihan menjadi 118.898

3.5 
## Ringkasan Variabel Utama Setelah Penanganan Nilai Null

Berikut adalah ringkasan variabel utama yang telah dilakukan penanganan nilai null pada dataset:
...
Penanganan nilai null ini membantu memberikan makna yang lebih jelas terhadap variabel `agent` dan `company`, sehingga analisis selanjutnya dapat lebih terarah dan informatif.
